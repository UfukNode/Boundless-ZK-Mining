...
# Renkli çıktılar için renk kodları
GREEN='\033[0;32m'
YELLOW='\033[1;33m'
RED='\033[0;31m'
BLUE='\033[0;34m'
...
case $NETWORK_CHOICE in
    1)
        NETWORK="eth-sepolia"
        ENV_FILE=".env.broker.eth-sepolia"
        ;;
    2)
        NETWORK="base-sepolia"
        ENV_FILE=".env.broker.base-sepolia"
        ;;
    3)
        NETWORK="base"
        ENV_FILE=".env.broker.base"
        ;;
    *)
...
WALLET_ADDRESS=$(echo $PRIVATE_KEY | xargs -I {} cast wallet address {})
echo -e "Cüzdan adresi: $WALLET_ADDRESS"
...
# Bakiye sorgulama (cast kullanarak)
